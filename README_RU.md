...
Если вы хотите внести свой вклад в проект, не стесняйтесь разветвлять репозиторий и отправлять запрос на обновление. Ознакомьтесь с [Рекомендациями по внесению вклада](CONTRIBUTING.md) для получения более подробной информации.
