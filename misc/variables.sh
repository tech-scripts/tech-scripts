...
TECH_COMMAND_DIR=$(echo "$PATH" | cut -d':' -f1)
...
BASIC_DIRECTORY="$USER_DIR/tmp/tech-scripts $USER_DIR/etc/tech-scripts $USER_DIR/usr/local/tech-scripts $TECH_COMMAND_DIR"
