...
if [[ "$LANGUAGE" == "Русский" ]]; then
    ...
    CREATE_SCRIPT_SSH="Создание скрипта в /usr/local/tech-scripts/alert.sh..."
    ...
    REMOVE_CONFIG_SSH="Хотите удалить конфигурационный файл /etc/tech-scripts/alert.conf?"
    REMOVE_SCRIPT_SSH="Хотите удалить скрипт /usr/local/tech-scripts/alert.sh?"
    ...
    EDIT_MSG="Хотите открыть /usr/local/tech-scripts/autostart.sh для редактирования?"
    INVALID_EDITOR="Неверный выбор редактора. Пожалуйста, выберите nano или vim!"
    SCRIPT_LOCATION="Скрипт autostart.sh расположен по адресу: /usr/local/tech-scripts/autostart.sh"
    SERVICE_EXISTS="Служба autostart.service уже существует!"
    REMOVE_SERVICE_MSG="Хотите удалить авто запуск autostart.service?"
    SERVICE_REMOVED="Служба autostart.service успешно удалена!"
    SERVICE_REMOVE_ERROR="Ошибка: не удалось удалить службу autostart.service!"
    DIR_ERROR="Ошибка: не удалось создать директорию /usr/local/tech-scripts"
    SCRIPT_ERROR="Ошибка: не удалось создать файл /usr/local/tech-scripts/autostart.sh!"
    CHMOD_ERROR="Ошибка: не удалось сделать файл /usr/local/tech-scripts/autostart.sh исполняемым!"
    SERVICE_CREATE_ERROR="Ошибка: не удалось создать файл службы /etc/systemd/system/autostart.service!"
    ENABLE_ERROR="Ошибка: не удалось активировать службу autostart.service!"
    START_ERROR="Ошибка: не удалось запустить службу autostart.service!"
    ...
    CREATE_SCRIPT_SSH="Creating script in /usr/local/tech-scripts/alert.sh..."
    ...
    REMOVE_CONFIG_SSH="Do you want to remove the configuration file /etc/tech-scripts/alert.conf?"
    REMOVE_SCRIPT_SSH="Do you want to remove the script /usr/local/tech-scripts/alert.sh?"
    ...
    EDIT_MSG="Do you want to open /usr/local/tech-scripts/autostart.sh for editing?"
    INVALID_EDITOR="Invalid editor choice. Please choose nano or vim."
    SCRIPT_LOCATION="The autostart.sh script is located at: /usr/local/tech-scripts/autostart.sh"
    SERVICE_EXISTS="Service autostart.service already exists!"
    REMOVE_SERVICE_MSG="Do you want to remove autostart for autostart.service?"
    SERVICE_REMOVED="Service autostart.service successfully removed!"
    SERVICE_REMOVE_ERROR="Error: Failed to remove service autostart.service!"
    DIR_ERROR="Error: Failed to create directory /usr/local/tech-scripts"
    SCRIPT_ERROR="Error: Failed to create file /usr/local/tech-scripts/autostart.sh!"
    CHMOD_ERROR="Error: Failed to make /usr/local/tech-scripts/autostart.sh executable!"
    SERVICE_CREATE_ERROR="Error: Failed to create service file /etc/systemd/system/autostart.service!"
    ENABLE_ERROR="Error: Failed to enable service autostart.service!"
    START_ERROR="Error: Failed to start service autostart.service!"
