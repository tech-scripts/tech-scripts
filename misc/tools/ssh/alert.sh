...
if [[ "$LANG_CONF" == "Русский" ]]; then
    ...
    MSG_TEST_MESSAGE="✅ Вы успешно настроили систему оповещений о входах по SSH через Telegram. Теперь вы будете получать уведомления о всех попытках входа в вашу систему! ✅"
    ...
    MSG_TEST_MESSAGE="✅ You have successfully configured SSH login alerts via Telegram. You will now receive notifications for all login attempts to your system! ✅"
